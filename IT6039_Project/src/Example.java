...
public class Example {
    ...
    public static void main(String[] args) {
        ...
        manifest.addProduct(new Product("Hammer", 3, true, false, false), 1);
        manifest.addProduct(new Product("Nails", 1, true, false, false), 12);
        manifest.addProduct(new Product("Ladder", 15, true, false, false), 2);
        manifest.addProduct(new Product("Saw", 5, false, true, false), 1);
        manifest.addProduct(new Product("Light Bulbs", 1, true, false, true), 20);
        manifest.addProduct(new Product("Weedkiller", 2, true, true, false), 1);
